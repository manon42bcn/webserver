...
\item 
void \mbox{\hyperlink{class_client_data_aaf2c37cb4c585c6b0c36eed1bd937c01}{to\+\_\+pollout}} ()
\item 
void \mbox{\hyperlink{class_client_data_aa93eda5e44b2ce98fa0e4807d0b889fd}{to\+\_\+pollin}} ()
...
\Hypertarget{class_client_data_ace64209b0eb0ecf17b839c04e9800f38}\index{ClientData@{ClientData}!ClientData@{ClientData}}
\index{ClientData@{ClientData}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{ClientData()}{ClientData()}}
{\footnotesize\ttfamily \label{class_client_data_ace64209b0eb0ecf17b839c04e9800f38} 
Client\+Data\+::\+Client\+Data (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{class_socket_handler}{Socket\+Handler}} \texorpdfstring{$\ast$}{*}}]{server}{, }\item[{const \mbox{\hyperlink{class_logger}{Logger}} \texorpdfstring{$\ast$}{*}}]{log}{, }\item[{int}]{fd}{}\end{DoxyParamCaption})}
...
\hline
\end{DoxyParams}
\Hypertarget{class_client_data_a722d09ec49cd3e0f33c1394a78441070}\index{ClientData@{ClientData}!````~ClientData@{\texorpdfstring{$\sim$}{\string~}ClientData}}
...
{\footnotesize\ttfamily \label{class_client_data_a722d09ec49cd3e0f33c1394a78441070} 
Client\+Data\+::\texorpdfstring{$\sim$}{\string~}\+Client\+Data (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
\Hypertarget{class_client_data_a1996039013d4a9fb82c2e9859ff405b2}\index{ClientData@{ClientData}!chronos\_connection@{chronos\_connection}}
...
{\footnotesize\ttfamily \label{class_client_data_a1996039013d4a9fb82c2e9859ff405b2} 
bool Client\+Data\+::chronos\+\_\+connection (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{class_client_data_aad28a2f07d9ff1a091755802a75fc3b9}\index{ClientData@{ClientData}!chronos\_request@{chronos\_request}}
...
{\footnotesize\ttfamily \label{class_client_data_aad28a2f07d9ff1a091755802a75fc3b9} 
bool Client\+Data\+::chronos\+\_\+request (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{class_client_data_a926a452ea3e46acfe12db36737bfffe7}\index{ClientData@{ClientData}!chronos\_reset@{chronos\_reset}}
\index{chronos\_reset@{chronos\_reset}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{chronos\_reset()}{chronos\_reset()}}
{\footnotesize\ttfamily \label{class_client_data_a926a452ea3e46acfe12db36737bfffe7} 
void Client\+Data\+::chronos\+\_\+reset (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}



Resets the client activity timestamp to the current time. 

Updates {\ttfamily \+\_\+timestamp} with the current time, effectively marking recent activity and resetting the timeout period for the client. \Hypertarget{class_client_data_a9f63bd0b5139b2d76a656342b6c26075}\index{ClientData@{ClientData}!client\_request@{client\_request}}
...
{\footnotesize\ttfamily \label{class_client_data_a9f63bd0b5139b2d76a656342b6c26075} 
\mbox{\hyperlink{structs__request}{s\+\_\+request}} \& Client\+Data\+::client\+\_\+request (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}

\Hypertarget{class_client_data_aa5eb5efbe94407c96d370c36b1847610}\index{ClientData@{ClientData}!close\_fd@{close\_fd}}
\index{close\_fd@{close\_fd}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{close\_fd()}{close\_fd()}}
{\footnotesize\ttfamily \label{class_client_data_aa5eb5efbe94407c96d370c36b1847610} 
void Client\+Data\+::close\+\_\+fd (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
\end{DoxyNote}
\Hypertarget{class_client_data_a21120ede60438ddc6947ebdf74259268}\index{ClientData@{ClientData}!deactivate@{deactivate}}
\index{deactivate@{deactivate}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{deactivate()}{deactivate()}}
{\footnotesize\ttfamily \label{class_client_data_a21120ede60438ddc6947ebdf74259268} 
void Client\+Data\+::deactivate (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}



Marks the client connection as inactive. 

Sets {\ttfamily \+\_\+active} to {\ttfamily false}, indicating that the client connection is no longer active. This can be used in conjunction with timeout checks or when a connection is manually closed. \Hypertarget{class_client_data_ac23ae0bd953e3bfd68bbbc72e2ba0895}\index{ClientData@{ClientData}!get\_fd@{get\_fd}}
\index{get\_fd@{get\_fd}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{get\_fd()}{get\_fd()}}
{\footnotesize\ttfamily \label{class_client_data_ac23ae0bd953e3bfd68bbbc72e2ba0895} 
struct pollfd Client\+Data\+::get\+\_\+fd (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{class_client_data_a72d1aba7c8b240eb3859762d076f77fe}\index{ClientData@{ClientData}!get\_server@{get\_server}}
\index{get\_server@{get\_server}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{get\_server()}{get\_server()}}
{\footnotesize\ttfamily \label{class_client_data_a72d1aba7c8b240eb3859762d076f77fe} 
\mbox{\hyperlink{class_socket_handler}{Socket\+Handler}} \texorpdfstring{$\ast$}{*} Client\+Data\+::get\+\_\+server (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{class_client_data_af0767f15de3c837f6e977a5aef8c1e87}\index{ClientData@{ClientData}!is\_active@{is\_active}}
\index{is\_active@{is\_active}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{is\_active()}{is\_active()}}
{\footnotesize\ttfamily \label{class_client_data_af0767f15de3c837f6e977a5aef8c1e87} 
bool Client\+Data\+::is\+\_\+active (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const}
...
\end{DoxyReturn}
\Hypertarget{class_client_data_a3280a4659590dcf30568d3ab2effc346}\index{ClientData@{ClientData}!is\_alive@{is\_alive}}
\index{is\_alive@{is\_alive}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{is\_alive()}{is\_alive()}}
{\footnotesize\ttfamily \label{class_client_data_a3280a4659590dcf30568d3ab2effc346} 
bool Client\+Data\+::is\+\_\+alive (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const}
...
\end{DoxyReturn}
\Hypertarget{class_client_data_a5ae6121bc925284da977c3eaebe12222}\index{ClientData@{ClientData}!keep\_active@{keep\_active}}
\index{keep\_active@{keep\_active}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{keep\_active()}{keep\_active()}}
{\footnotesize\ttfamily \label{class_client_data_a5ae6121bc925284da977c3eaebe12222} 
void Client\+Data\+::keep\+\_\+active (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}



Sets the client connection as active. 

Updates the {\ttfamily \+\_\+active} flag to {\ttfamily true}, indicating that the client connection is currently in use and not eligible for cleanup or timeout handling. \Hypertarget{class_client_data_a11bd829d13b5b868f2c30469484b4e75}\index{ClientData@{ClientData}!kill\_client@{kill\_client}}
\index{kill\_client@{kill\_client}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{kill\_client()}{kill\_client()}}
{\footnotesize\ttfamily \label{class_client_data_a11bd829d13b5b868f2c30469484b4e75} 
void Client\+Data\+::kill\+\_\+client (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}



Sets the client life cycle to false. 

Updates the {\ttfamily \+\_\+alive} flag to {\ttfamily false}, indicating that the client connection Process should end. \Hypertarget{class_client_data_aa93eda5e44b2ce98fa0e4807d0b889fd}\index{ClientData@{ClientData}!to\_pollin@{to\_pollin}}
\index{to\_pollin@{to\_pollin}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{to\_pollin()}{to\_pollin()}}
{\footnotesize\ttfamily \label{class_client_data_aa93eda5e44b2ce98fa0e4807d0b889fd} 
void Client\+Data\+::to\+\_\+pollin (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}

\Hypertarget{class_client_data_aaf2c37cb4c585c6b0c36eed1bd937c01}\index{ClientData@{ClientData}!to\_pollout@{to\_pollout}}
\index{to\_pollout@{to\_pollout}!ClientData@{ClientData}}
\doxysubsubsection{\texorpdfstring{to\_pollout()}{to\_pollout()}}
{\footnotesize\ttfamily \label{class_client_data_aaf2c37cb4c585c6b0c36eed1bd937c01} 
void Client\+Data\+::to\+\_\+pollout (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
