...
/*   Updated: 2024/11/17 23:14:11 by mporras-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void HttpAutoIndex::get_file_content(std::string& path) {
	...
	out << "<style>body { font-family: Arial, sans-serif; } table { border-collapse: collapse; } th, td { border: 1px solid #ddd; padding: 8px; } th { text-align: left; }</style>\n";
	out << "</head>\n<body>\n";
	out << "<h1>Index of " << _request.path << "</h1>\n";
